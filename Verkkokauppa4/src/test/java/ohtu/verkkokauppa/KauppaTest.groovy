...
class KauppaTest {
    ...
    @Test
    public void pankinMetodiaKutsutaanOikeillaParams() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void toimiiOikeinKahdellaTuotteella() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    public void eiToimiJosTuotettaEiOle() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void aloitaAsiointiKutsuNollaaOstoskorin() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
    ...
    @Test
    public void kauppaPyytaaJokaMaksulleUudenViitteen() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
